...
<div class="flex flex-col shadow-lg rounded-b-2xl mx-5">
      <h2
        class="
          ...
          py-2
          rounded-t-2xl
          border-solid border-2 border-purple-800
        "
      >
        ${name}
      </h2>
      <div
        class="
          ...
          md:px-5
          rounded-b-2xl
          border-solid border-2 border-t-0 border-purple-800
        "
      >
        <div class="table">
          <div class="table-row">
          ...
          <div class="table-row">
            <div class="table-cell"><i class="${getExtraIcon(role)}"></i></div>
            <div class="table-cell">${getExtraData(employee, role)}</div>
          </div>
        </div>
      </div>
    </div>
...
function getExtraData(employee) {
  switch (role) {
    case 'Manager':
...
<html lang="en">
  ...
  <body class="bg-purple-100 overflow-x-hidden">
    <!-- Header content here  -->
    <header
      class="flex justify-center items-center bg-purple-400 black w-100 h-14"
    >
    ...
    ${team.employee.forEach((employee) => generateEmployeeHTML(employee))}
